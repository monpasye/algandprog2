    ...
    static void Main() {
        ...
        do { 
            ...
            switch (number) {
                ...
                case 1:
                    Console.WriteLine("Фамилия, имя и отчество работника: ");
                    ...
                    Console.WriteLine("Данные о работнике внесены.\n");
...
class Worker {
    ...
    public void Education(int Inp) { 
        ...
        if (ans == 0) Console.WriteLine("Работников, владеющих данным образованием, нет.");
    }
    public void OneJob() { 
        int i = 0, ans = 0;
    ...
    public void Age(string Inp) {
        ...
        if (ans == 0) Console.WriteLine("Работников, рождённых в этот год, нет.");
